...
CS fresh graduate & Full-Stack Software Engineer specializing in building scalable web applications and backend systems. Currently focused on building real-world projects from scratch to deployment, mastering modern stacks, and writing clean, maintainable code.
...
<table align="center" width="100%">
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <ul>
        <li>Real-time ticket reservation engine with seat concurrency locks.</li>
    ...
    <td width="50%" valign="top">
      ...
      <p align="center">
        <b>Collaborative Educational Workspace</b>
      </p>
      <p align="center">
        <img src="https://skillicons.dev/icons?i=nodejs,ts,mongodb,react,tailwind&theme=dark" height="28" />
      </p>
      <ul>
        <li>Interactive task management boards and real-time activity sync.</li>
